...
<body onload="init()">
    <div id="info">
        ...
        <table id="testInfo">
            <tr>
                ...
                <td class="sub" id="testName"></td>
            </tr>
            <tr>
                <td class="title">응시기간</td>
                <td class="sub" id="testDuration"></td>
            </tr>
            <tr>
                <td class="title">시험시간</td>
                <td class="sub" id="testTime"></td>
            </tr>
            <tr>
                <td class="title">자동/수동채점여부</td>
                <td class="sub" id="testAuto"></td>
            </tr>
        </table>
        ...
        <table id="questionInfo">
            <thead>
                ...
                <td class="title" id="a">정답</td>
                <td class="title" id="sco">배점</td>
                <td class="title" id="av">평균</td>
                <td class="title" id="wr">오답률</td>
            </thead>
        </table>
        <br>
    ...
    <div id="backbtn">
        <input type="button" value="돌아가기" class="btn" onclick="goBack()" id="back">
    </div>
    ...
    <script>
        ...
        function showQuestion(i){
                ...
                for(var j=0;j<tests[i].multipleChoice.length;j++){
                    ...
                    cell1.innerHTML = q;
                    cell2.innerHTML = "<center>"+tests[i].multipleChoice[j].answer+"</center>";
                    cell3.innerHTML = "<center>"+tests[i].multipleChoice[j].points+"</center>";
                    cell4.innerHTML = "<center>"+tests[i].multipleChoice[j].average+"</center>";
                    cell5.innerHTML = "<center>"+tests[i].multipleChoice[j].wrongrate+"</center>";
                }
                for(var j=0;j<tests[i].shortAnswer.length;j++){
                    ...
                    cell2.innerHTML = "<center>"+tests[i].shortAnswer[j].answer+"</center>";
                    cell3.innerHTML = "<center>"+tests[i].shortAnswer[j].points+"</center>";
                    cell4.innerHTML = "<center>"+tests[i].shortAnswer[j].average+"</center>";
                    cell5.innerHTML = "<center>"+tests[i].shortAnswer[j].wrongrate+"</center>";
                }
            }
